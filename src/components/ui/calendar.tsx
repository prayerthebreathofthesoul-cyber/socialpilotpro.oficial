  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "h-8 w-[--cell-size] select-none text-center align-middle text-[0.8rem] font-normal text-muted-foreground",
        ...
        day: cn(
          "relative h-[--cell-size] w-[--cell-size] select-none p-0 text-center align-middle",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex size-[--cell-size] min-w-[--cell-size] flex-col items-center justify-center gap-1 p-0 font-normal leading-none",
